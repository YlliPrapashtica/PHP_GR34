		...
		<div class="super_container">
			...
			<div class="home">
				...
				<div class="home_container d-flex flex-column align-items-center justify-content-center">
					<div class="home_title"><h1>Book Your Room Now</h1></div>
				</div>
			</div>
					...
					<form action="bookingValidator.php" method="POST">
						...
						<div class="form-row">
							<div class="form-wrapper">
								...
								<input type="date" class="form-control datepicker-here" name="check-in" data-language='en' pattern="\d{4}-\d{2}-\d{2}"  min="2020-01-01" max="2021-12-31">
							</div>
							<div class="form-wrapper">
								<label for="">Check-out *</label>
								<span class="lnr lnr-calendar-full"></span>
								<input type="date" class="form-control datepicker-here" name="check-out" data-language='en'  pattern="\d{4}-\d{2}-\d{2}" min="2020-01-01" max="2021-12-31">
							</div>
						</div>
						<?php
						require "connect.php";
						echo '<div class="form-row">';
							echo '<div class="form-wrapper">';
								echo '<label for="">Room Name *</label>';
									...
									echo '<select class="form-control" name="room" placeholder="Room Name">';
									$sql = "SELECT rt.room_type_name, rt.room_type_id, r.room_number FROM room_type rt, rooms r 
									WHERE rt.room_type_id = r.rooms_type_rooms_type_id  ORDER BY r.room_number ASC;";
									
									$result = mysqli_query($con,$sql);
										
									while ($row = mysqli_fetch_array ($result)) {
										echo "<option value='" . $row['room_number'] . "'>" . $row['room_number'] ."  .  ". $row['room_type_name'] . "</option>";
									}
